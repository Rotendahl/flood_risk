...
from code import get_storm_flood_img, address_to_lat_long, get_storm_flod_response


class TestFastning(unittest.TestCase):
    def test_get_flood_img(self):
        blox_coordinates = address_to_lat_long("Bryghusgade, 1473 København")
    ...
    def test_get_storm_flod_response(self):
        ...
        DIKU_coordinates = address_to_lat_long("Universitetsparken 1, 2100 København")
